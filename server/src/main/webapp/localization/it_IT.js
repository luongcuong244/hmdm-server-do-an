...
document.localization ['it_IT'] = {
	...
	'form.configuration.settings.common.admin.pwd': 'Password amministratore',
	'form.configuration.settings.common.admin.pwd.placeholder': 'Inserisci la password amministratore',
